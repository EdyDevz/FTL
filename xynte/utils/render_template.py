from xynte.vars import Var
from xynte.bot import StreamBot
from xynte.utils.human_readable import humanbytes
from xynte.utils.file_properties import get_file_ids
from xynte.server.exceptions import InvalidHash
import urllib.parse
import aiofiles
import logging
import aiohttp
...
async def render_page(id, secure_hash):
    ...
    if str(file_data.mime_type.split('/')[0].strip()) == 'video':
        async with aiofiles.open('xynte/template/req.html') as r:
        ...
        async with aiofiles.open('xynte/template/dl.html') as r:
...
<center>
    <h2>
        <a href="https://telegram.dog/+kc6bYRCsWdlhOTI1">
            <img src="https://graph.org/file/b57cdba982191a25db535.jpg" alt="xynte" width="150" height="75">
        </a>
    </h2>
</center>
